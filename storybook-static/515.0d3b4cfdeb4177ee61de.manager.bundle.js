/*! For license information please see 515.0d3b4cfdeb4177ee61de.manager.bundle.js.LICENSE.txt */
                ...
                for (
                  ...
                  if (!(str instanceof Token)) {
                    ...
                    if (greedy) {
                      ...
                      if (
                        ((pos = p -= currentNode.value.length), currentNode.value instanceof Token)
                      )
                        continue
                      for (
                        var k = currentNode;
