/*! For license information please see 528.5689995ad077abcf0cc1.manager.bundle.js.LICENSE.txt */
'use strict'
                        ...
                        if (
                          ...
                          if (
                            ...
                            var measuringElm = finalElement[0],
                              ...
                              elementSize = {
                                w:
                                  rawElementSize[_strWidth] + settingsMargin[3] + settingsMargin[1],
                                h:
                        ...
                        : (function () {
                            ...
                            if (FRAMEWORK.isPlainObject(classesOrAttrs))
                              for (key in classesOrAttrs)
                                attrs +=
                                  ('c' === key ? 'class' : key) + '="' + classesOrAttrs[key] + '" '
                            return attrs
                          })()
                      : _strEmpty) +
                    '>' +
